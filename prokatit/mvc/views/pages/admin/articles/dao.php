...
$getHeaderMeta = function() {
    $header['title'] = "Админка статей"; // or $this->viewConfig["action"] or $this->viewBag['product']['name'];
    $header['description'] = "Добавление статьей для клиентов";
    $header['keyWords'] = "статьи, админка, клиенты";
