...
$getHeaderMeta = function() {
    $header['title'] = "Админка - популярные товары"; // or $this->viewConfig["action"] or $this->viewBag['product']['name'];
    $header['description'] = "Добавление популярных товаров в админке";
    $header['keyWords'] = "админка, популярные товары";
